...
function entrar(){
    ...
    if (estado == 1){
        nao.style.transform="translate(130px, +40px)"
    }
    if (estado == 2){
        nao.style.transform="translate(-305px, +40px)"
    }
    if (estado == 3){
        nao.style.transform="translate(-345px, -40px)"
    }
    if (estado == 4){
        nao.style.transform="translate(+185px, +40px)"
    }
    if (estado == 5){
        nao.style.transform="translate(+155px, -40px)"
    }
    if (estado == 6){
        nao.style.transform="translate(-225px, +40px)"
    }
    if (estado == 7){
        nao.style.transform="translate(-25px, -40px)"
        estado = -1
    }
}
